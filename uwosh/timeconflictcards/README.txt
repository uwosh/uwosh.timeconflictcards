...
The TimeConflictCard content type
===============================

In this section we are tesing the TimeConflictCard content type by performing
basic operations like adding, updadating and deleting TimeConflictCard content
items.
...
'TimeConflictCard' and click the 'Add' button to get to the add form.
...
We check that the changes were applied.
    ...
    >>> 'Changes saved' in browser.contents
    True
    >>> 'Steve Jobs' in browser.contents
    True
...
Now we are going to delete the 'Steve Jobs' object. First we
go to the contents tab and select the 'Steve Jobs' for
deletion.
...
Not only site managers are allowed to add TimeConflictCard content items, but
